...
- Nhược điểm:
  ...
  - Authentication, Firestore Database là 2 thứ tách biệt nên khi cập nhật ở Firestore Database thì Authentication không được cập nhật theo
...
<br>
 <font size="21">=> Chốt lại là Firebase chỉ hợp làm dự án đơn giản, các chức năng authen của nó cũng khá bình thường và không hỗ trợ nhiều thứ </font>
